    ...
    while True:
        ...
        with engine.connect() as connection:
            ...
            for row in pin_selected_row:
                ...
                invoke_url = "https://um07lic68g.execute-api.us-east-1.amazonaws.com/dev/topics/12e618ec57ab.pin"
                payload = json.dumps({
                    "records": [{ 
            ...
            for row in geo_selected_row:
                ...
                invoke_url = "https://um07lic68g.execute-api.us-east-1.amazonaws.com/dev/topics/12e618ec57ab.geo"
                payload = json.dumps({
                    "records": [{ 
            ...
            for row in user_selected_row:
                ...
                invoke_url = "https://um07lic68g.execute-api.us-east-1.amazonaws.com/dev/topics/12e618ec57ab.user"
                payload = json.dumps({
                    "records": [{ 
